...
import HotelFacilitiesFIlter from "../components/HotelFaciliteisFilter";
...
const Search = () => {
  ...
  const handleHotelFacilitiesChange = (
    ...
    const currentFacilities = event.target.value;

    setSelectedHotelFacilities((prevHotelFacilities) =>
      event.target.checked
        ? [...prevHotelFacilities, currentFacilities]
        : prevHotelFacilities.filter(
            (facility) => facility !== currentFacilities
          )
    );
  };
